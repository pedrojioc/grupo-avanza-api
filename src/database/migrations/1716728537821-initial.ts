...
export class Initial1716728537821 implements MigrationInterface {
    name = 'Initial1716728537821'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`interests\` ADD CONSTRAINT \`FK_477042e18335cc99742a5c08f5e\` FOREIGN KEY (\`interest_state_id\`) REFERENCES \`interest_state\`(\`id\`) ON DELETE RESTRICT ON UPDATE NO ACTION`);
